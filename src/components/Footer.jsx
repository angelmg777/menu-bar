function Footer() {
  return (
    <footer className="bg-gray-900 border-t border-yellow-500/10 px-6 py-12 mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-4">
              ...
              Ven y descubre tu bebida favorita.
            </p>
            <div className="flex gap-3">
              {[
                ...
                <a
                    ...
                    className="bg-gray-800 hover:bg-yellow-400/10 border border-white/5 hover:border-yellow-500/30 text-gray-400 hover:text-yellow-400 w-10 h-10 rounded-xl flex items-center justify-center transition-all"
                    title={red.label}
                >
                    {red.svg}
                </a>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                { dia: 'Lunes - Jueves', hora: '5:00 PM – 12:00 AM' },
                { dia: 'Viernes - Sábado', hora: '5:00 PM – 2:00 AM' },
                { dia: 'Domingo', hora: '4:00 PM – 11:00 PM' },
              ].map((h) => (
                <li key={h.dia} className="flex justify-between text-sm">
                  <span className="text-gray-500">{h.dia}</span>
                  <span className="text-yellow-400/70">{h.hora}</span>
                </li>
              ))}
            </ul>
          </div>
